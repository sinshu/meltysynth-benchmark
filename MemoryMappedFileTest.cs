...
public class MemoryMappedFileTest : IDisposable
{
    ...
    public MemoryMappedFileTest(bool useMmf)
    {
        soundFont = new SoundFont(Settings.SoundFontPath, useMmf);
        ...
        var name = useMmf ? "mmf_on.wav" : "mmf_off.wav";
