...
namespace AudioSynthesis.Synthesis
{
    public partial class Synthesizer
    {
        ...
        public const float NonAudible = 1e-3f;          //lowest value for volume
        public const int SincWidth = 16;                //size of sinc window
        public const int SincResolution = 64;                  //number of points between window positions (resolution of sinc)
